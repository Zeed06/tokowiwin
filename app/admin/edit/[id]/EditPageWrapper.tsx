      ...
      <div className="bg-gray-50 min-h-screen py-8 sm:py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-gray-200 p-6 sm:p-8">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Edit Produk</h1>
            <p className="text-gray-600 mb-6 sm:mb-8 text-sm sm:text-base">Ubah informasi produk di bawah ini</p>
